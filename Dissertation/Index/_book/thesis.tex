...
\bottomrule
\end{longtable}
\endgroup{} Table \ref{tab:suppsumm}: Competing models with relative
support (ΔAIC \textless{} 2) using AIC analysis for each response
variable, where the most parsimonious models with the most support are
shown in bold. Reported are ΔAIC and the hypothesis supported by each
model: H1 is a bank effect not caused by salmon manipulation, H2 is a
...
\toprule
Distance & X1 m & X & X3 m & X 1 & X6 m & X 2 & X10 m & X 3 & X20 m & X 4\\
\midrule
Bank & Enhanced & Depleted & Enhanced & Depleted & Enhanced & Depleted & Enhanced & Depleted & Enhanced & Depleted\\
...
This version of the thesis was generated on 2021-05-24 09:42:25. The
